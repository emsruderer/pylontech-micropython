class PylontechDecode:
    ...
    def decodeAlarmInfo(self):
        if self.data['ID'] == 0x46:
            ...
            for c in range(0, self.data['TemperatureCount']):
                ...
                i = i + 2
            self.data['Temperatures'] = temperatureAlarm

            self.data['ChargeCurent'] = self.alarm(payload[i:i + 2])
            i = i + 2
    ...
    def decodeSystemParameter(self):
        ...
        if (self.data['ID'] == 0x46) and (len(payload) == 50):
            ...
            i += 4
            self.data['CellLowerVoltageLimit'] = self.cellVoltage(payload[i:i+4])
            i += 4
            ...
            i += 4
            self.data['UnderVoltageTreshold'] = self.moduleVoltage(payload[i:i+4])
            i += 4
            ...
            self.data['UpperLimitVoltage'] = None
            self.data['LowerLimitVoltage'] = None
